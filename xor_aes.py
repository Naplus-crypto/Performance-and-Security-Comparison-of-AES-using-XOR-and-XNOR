...
def pad(plaintext):
    ...
    Note that if the plaintext size is already a multiple of 16,
    no padding will be added.
    """
    # คำนวณความยาวของ padding ที่ต้องการ
    padding_len = 16 - (len(plaintext) % 16)
    # สร้าง padding โดยใช้ความยาวของ padding
    padding = bytes([padding_len] * padding_len)
    # เพิ่ม padding เข้ากับข้อความ
